...
namespace Weboldalnet\CommerceCoupons\Console;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\Artisan;
use Weboldalnet\CommerceCoupons\Support\PackageHelper;

class InstallCommerceCouponsCommand extends Command
{
    ...
    public function handle()
    {
        ...
        Artisan::call('vendor:publish', [
            '--provider' => 'Weboldalnet\\CommerceCoupons\\CommerceCouponsServiceProvider',
            '--tag' => $tag,
            '--force' => true,
        ]);
